...
export default function MobileWhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`whatsapp-cta fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-white shadow-lg transition-all duration-200 hover:scale-[1.02] hover:shadow-xl active:scale-[1.02] active:shadow-xl md:hidden ${
        visible
